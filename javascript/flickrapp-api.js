...
if (! info.aaronland.flickrapp){
    info.aaronland.flickrapp = {};
}

info.aaronland.flickrapp.JSON = (typeof(JSON) == 'object') ? 1 : 0;

info.aaronland.flickrapp.API = function(args){
    this.args = args;

    this.host = args['host'];
    this.endpoint = '/api';   

    if (! info.aaronland.flickrapp.JSON){
        ...
        info.aaronland.flickrapp.JSON = 1;
    }

};

info.aaronland.flickrapp.API.prototype.api_call = function(method, args, doThisOnSuccess, doThisIfNot){
    ...
    // why does safari hate this? what does safari hate the internet?
...
info.aaronland.flickrapp.API.prototype.log = function(msg){
